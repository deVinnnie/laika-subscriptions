INSERT INTO subscriber(id, voornaam, achternaam, email, active, subscription_date)
VALUES('10', 'Luke', 'Skywalker', 'luke@rebellion.org', true, '2015-01-01 18:00:00'),
      ('20', 'Leia', 'Organa', 'leia@rebellion.org', true, '2015-01-01 18:00:00'),
      ('30', 'Han', 'Solo', 'han@rebellion.org', true, '2015-01-01 18:00:00');
